System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SocketConnection", SocketConnection = (_dec = ccclass('SocketConnection'), _dec(_class = (_class2 = (_temp = _class3 = class SocketConnection extends Component {
        constructor() {
          super();
          ...
          try {
            ...
            */
            ...
            this.room.state.playerMap.onAdd = (player, key) => {
              ...
              this.isConnected = true; // add your player entity to the game world!

              this.addPlayerToWorld(player, key); // If you want to track changes on a child object inside a map, this is a common pattern:
      ...
      }, _defineProperty(_class3, "instance", void 0), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "hostname", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
