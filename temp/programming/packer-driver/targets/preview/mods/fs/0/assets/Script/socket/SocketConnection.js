System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context2) {
  ...
  var _reporterNs, _cclegacy, Component, _decorator, Colyseus, _dec, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _temp, _crd, ccclass, property, SocketConnection;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SocketConnection", SocketConnection = (_dec = ccclass('SocketConnection'), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
        ...
        function SocketConnection() {
          ...
          SocketConnection.instance = _assertThisInitialized(_this);
          return _this;
        }
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 3:
                    ...
                    console.log("user's sessionId:", this.room.sessionId); // this.room.onStateChange((state) => {
                    ...
                    */
                    ...
                    this.room.state.playerMap.onAdd = function (player, key) {
                      ...
                      _this2.isConnected = true; // add your player entity to the game world!

                      _this2.addPlayerToWorld(player, key); // If you want to track changes on a child object inside a map, this is a common pattern:
        ...
        _proto.addPlayerToWorld = function addPlayerToWorld(player, key) {};

        return SocketConnection;
      }(Component), _defineProperty(_class3, "instance", void 0), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "hostname", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
